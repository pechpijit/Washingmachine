...
public class AdapterSettingLanguage extends RecyclerView.Adapter<AdapterSettingLanguage.VersionViewHolder> {
    ArrayList<String> model;
    Context context;
    OnItemClickListener clickListener;
    PrefUtils prefUtils;

    public AdapterSettingLanguage(Context applicationContext, ArrayList<String> model) {
